...
void calculation ( string expression )
{
    ...
    while (i<expression.length())
        ...
        if ((expression[i]>=48)&&(expression[i]<=57))
            {RPN_expression[g].push_back(expression[i]);i++;}
        else
            if (expression[i]=='+')
                {  if((texas.length()==0)||(texas[texas.length()-1]=='('))
                    {texas.push_back(expression[i]);i++;g++;RPN_expression.push_back("");}
                else
                    {g++;RPN_expression.push_back("");
                        RPN_expression[g].push_back(texas[texas.length()-1]);
                        g++;RPN_expression.push_back(""); texas.pop_back();}
                }
            else
                if (expression[i]=='-')
                    {  if((texas.length()==0)||(texas[texas.length()-1]=='('))
                        ...
                        {g++;RPN_expression.push_back("");RPN_expression.push_back("");RPN_expression[g].push_back(texas[texas.length()-1]);g++;RPN_expression.push_back(""); texas.pop_back();}
                    }
                else
                    if (expression[i]=='*')
                        {
                        if ((texas[texas.length()-1]=='+')||(texas[texas.length()-1]=='-')||(texas[texas.length()-1]=='(')||(texas.length()==0))
                            { texas.push_back(expression[i]);i++;g++;RPN_expression.push_back("");}
                        else {g++;RPN_expression.push_back("");RPN_expression[g].push_back(texas[texas.length()-1]);g++;RPN_expression.push_back(""); texas.pop_back();}
                        }
                    else
                        if (expression[i]=='/')
                            {
                            ...
                            if (expression[i]=='%')
                                ...
                                if (expression[i]=='(')
                                    { texas.push_back(expression[i]);i++;}
                                else
                                    if (expression[i]==')')
                                        {
                                        if (texas[texas.length()-1]=='(')
                                            ...
                                            {g++;RPN_expression.push_back("");RPN_expression[g].push_back(texas[texas.length()-1]);g++;RPN_expression.push_back(""); texas.pop_back();}
                                        }
...
string proceesing (string s)
{
    ...
    for (int i=0;i<s.length();i++)
        ...
        if ((s[i]>=48)&&(s[i]<=57))
            ...
            if (s[i]=='(')
                { expression.push_back(s[i]); balance++;}
            else
                if (s[i]==')')
                    {expression.push_back(s[i]);  balance--;}
                else
